...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("claude-oauth",   "Claude (Claude Code OAuth)", "Anthropic Claude via Claude Code OAuth (~/.claude/.credentials.json)"),
    ...
    ProviderEntry("gemini-oauth",   "Google Gemini (OAuth)",    "Google Gemini via Antigravity OAuth (~/.config/antigravity/tokens.json)"),
...
PROVIDER_GROUPS: dict[str, tuple[str, str, list[str]]] = {
    ...
    "anthropic": ("Anthropic Claude", "API key or Claude Code OAuth", ["anthropic", "claude-oauth"]),
    "google":   ("Google Gemini",   "Google AI Studio (API key) or Antigravity (OAuth)", ["gemini", "gemini-oauth", "vertex"]),
